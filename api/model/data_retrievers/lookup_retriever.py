...
class LookupRetriever:
    ...
    def _get_final_candidates_list(
        ...
        for entity in result:
            ...
            obj = {
                ...
                "WD_type": entity.get("WD_type", None),
                "ext_WD_type": entity.get("ext_WD_type", None),
    ...
    def add_or_update_cache(self, body, final_result, limit):
        ...
        query = {
            ...
            "WD_type": body.get("WD_type"),
            "ext_WD_type": body.get("ext_WD_type"),
    ...
    def create_query(
        self, name, fuzzy=False, types=None, kind=None, NERtype=None, WD_type=None, ext_WD_type=None, language=None
    ):
        # Base query
        query_base = {

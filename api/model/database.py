    ...
    def populate_fake_db(self):
        ...
        for _ in range(nrandom_exmple):
            items_data = {
                ...
                "aliases": {
                    fake.language_code(): [fake.word() for _ in range(random.randint(1, 3))]
                    for _ in range(random.randint(1, 5))
                },
                "types": {
                    "P31": [f"Q{fake.random_number(digits=5)}" for _ in range(random.randint(1, 3))]
                    for _ in range(random.randint(1, 5))
                },
        ...
        for _ in range(nrandom_exmple):
            objects_data = {
                ...
                "objects": {"Q" + str(fake.random_number(digits=5)): ["P" + str(fake.random_number(digits=5))]},
            }
        ...
        for _ in range(nrandom_exmple):
            types_data = {
                "id_entity": fake.random_number(digits=5),
                "entity": "Q" + str(fake.random_number(digits=5)),
                "types": {"P" + str(fake.random_number(digits=5)): ["Q" + str(fake.random_number(digits=5))]},
            }
            ...
            for collection, fields in index_specs.items():
                if collection == "cache":
                    db[collection].create_index(
                        [("cell", 1), ("fuzzy", 1), ("type", 1), ("kg", 1), ("limit", 1)], unique=True
                    )

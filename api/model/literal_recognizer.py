...
class LiteralRecognizer:
    ...
    literal_types = {
        "datetime": datetime_pattern_to_match,
        "time": time_pattern_to_match,
        "url": url_pattern_to_match,
        "email": email_pattern_to_match,
        "float": float_pattern_to_match,
        "integer": integer_pattern_to_match,
        "date": date_pattern_to_match,
    }
